#
# $Id: IMAPUTF7.pm,v 1.1.1.1 2005/09/27 12:16:29 sava Exp $
#
package Encode::Unicode::IMAPUTF7;

use strict;
no warnings 'redefine';
use base qw(Encode::Encoding);
__PACKAGE__->Define('IMAP-UTF-7');
our $VERSION = '1.00';
use MIME::Base64;
use Encode;
...
Encode::Unicode::IMAPUTF7 - modification of UTF-7 encoding for IMAP
...
at http://rt.cpan.org/ or email to bug-Encode-Unicode-IMAPUTF7@rt.cpan.org. 

http://rt.cpan.org/NoAuth/Bugs.html?Dist=Encode-Unicode-IMAPUTF7 is the RT queue for Encode::Unicode::IMAPUTF7.
